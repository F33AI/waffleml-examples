...
from common.featurization.read_data import read_train_test
...
def train(traininig_data_path: str, hyperparameters: Dict[str, Any]) -> str:
    """ ...
    ...
    df = read_train_test(traininig_data_path)
    ...
    all_pairs = {
        (s, i): df[(df["date"] >= last_train_day) & (df["store"] == s) & (df["item"] == i)]["sales"].tolist()[0]
